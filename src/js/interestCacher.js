...
console.log("Here bro! "+str);
if(str=="chrome-extension://nkojhoghcdplldmdpplakbnolopmfalb/html/newInterestPage.html"){
...
function fillUsingCachedValues(){
  var websearch, images, videos;
